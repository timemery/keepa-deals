...
# Chunk 5 starts
# Dev Log: Processes header fields for CSV output (2025-04-27).
...
# Fixed get_field signature to match caller (product_365, deal, product_90, header, field_map) and removed redundant file loading (2025-04-27).
def get_field(product_365, deal, product_90, header, field_map):
    ...
    if header == "Price Now":
        ...
        # Logic for other fields (e.g., ASIN, Title)
        ...
        value = "-"
        try:
            if isinstance(field_map, dict) and field_map.get("source"):
                ...
                value = field_map  # Fallback for unmapped headers
