...
def used_like_new(product):
    ...
    result = {
        ...
        'Used, like new - Lowest': '-',  # Placeholder
        'Used, like new - Lowest 365 days': '-',  # Placeholder
        'Used, like new - Highest': '-',  # Placeholder
        'Used, like new - Highest 365 days': '-',  # Placeholder
        'Used, like new - 90 days OOS': get_stat_value(stats, 'outOfStock90', 4, is_price=False),
        'Used, like new - Stock': '-'  # Placeholder
    }
...
def used_very_good(product):
    ...
    result = {
        ...
        'Used, very good - Lowest': '-',  # Placeholder
        'Used, very good - Lowest 365 days': '-',  # Placeholder
        'Used, very good - Highest': '-',  # Placeholder
        'Used, very good - Highest 365 days': '-',  # Placeholder
        'Used, very good - 90 days OOS': get_stat_value(stats, 'outOfStock90', 5, is_price=False),
        'Used, very good - Stock': '-'  # Placeholder
    }
...
def used_good(product):
    ...
    result = {
        ...
        'Used, good - Lowest': '-',  # Placeholder
        'Used, good - Lowest 365 days': '-',  # Placeholder
        'Used, good - Highest': '-',  # Placeholder
        'Used, good - Highest 365 days': '-',  # Placeholder
        'Used, good - 90 days OOS': get_stat_value(stats, 'outOfStock90', 6, is_price=False),
        'Used, good - Stock': '-'  # Placeholder
    }
...
def used_acceptable(product):
    ...
    result = {
        ...
        'Used, acceptable - Lowest': '-',  # Placeholder
        'Used, acceptable - Lowest 365 days': '-',  # Placeholder
        'Used, acceptable - Highest': '-',  # Placeholder
        'Used, acceptable - Highest 365 days': '-',  # Placeholder
        'Used, acceptable - 90 days OOS': get_stat_value(stats, 'outOfStock90', 7, is_price=False),
        'Used, acceptable - Stock': '-'  # Placeholder
    }
