...
from stable import get_stat_value, get_title, get_asin, sales_rank_current, used_current, sales_rank_30_days_avg, sales_rank_90_days_avg, sales_rank_180_days_avg, sales_rank_365_days_avg, package_quantity, package_weight, package_height, package_length, package_width, used_like_new, used_very_good, used_good, used_acceptable, new_3rd_party_fbm_current, used_like_new_lowest_highest, list_price, new_3rd_party_fbm, used_like_new as stable_used_like_new, used_very_good as stable_used_very_good, used_good as stable_used_good, used_acceptable as stable_used_acceptable, list_price as stable_list_price
...
FUNCTION_MAP = {
    ...
    "Used, like new - 30 days avg.": stable_used_like_new,
    "Used, like new - 60 days avg.": stable_used_like_new,
    "Used, like new - 90 days avg.": stable_used_like_new,
    "Used, like new - 180 days avg.": stable_used_like_new,
    "Used, like new - 365 days avg.": stable_used_like_new,
    ...
    "Used, like new - 90 days OOS": stable_used_like_new,
    "Used, like new - Stock": stable_used_like_new,
    "Used, very good - Current": used_very_good,
    "Used, very good - 30 days avg.": stable_used_very_good,
    "Used, very good - 60 days avg.": stable_used_very_good,
    "Used, very good - 90 days avg.": stable_used_very_good,
    "Used, very good - 180 days avg.": stable_used_very_good,
    "Used, very good - 365 days avg.": stable_used_very_good,
    ...
    "Used, very good - Stock": stable_used_very_good,
    "Used, good - Current": used_good,
    "Used, good - 30 days avg.": stable_used_good,
    "Used, good - 60 days avg.": stable_used_good,
    "Used, good - 90 days avg.": stable_used_good,
    "Used, good - 180 days avg.": stable_used_good,
    "Used, good - 365 days avg.": stable_used_good,
    "Used, good - Lowest": None,
    "Used, good - Lowest 365 days": None,
    "Used, good - Highest": None,
    "Used, good - Highest 365 days": None,
    "Used, good - 90 days OOS": stable_used_good,
    "Used, good - Stock": stable_used_good,
    "Used, acceptable - Current": used_acceptable,
    "Used, acceptable - 30 days avg.": stable_used_acceptable,
    "Used, acceptable - 60 days avg.": stable_used_acceptable,
    "Used, acceptable - 90 days avg.": stable_used_acceptable,
    "Used, acceptable - 180 days avg.": stable_used_acceptable,
    "Used, acceptable - 365 days avg.": stable_used_acceptable,
    ...
    "Used, acceptable - 90 days OOS": stable_used_acceptable,
    "Used, acceptable - Stock": stable_used_acceptable,
    "List Price - Current": list_price,
    "List Price - 30 days avg.": stable_list_price,
    "List Price - 60 days avg.": stable_list_price,
    "List Price - 90 days avg.": stable_list_price,
    "List Price - 180 days avg.": stable_list_price,
    "List Price - 365 days avg.": stable_list_price,
    "List Price - Lowest": None,
    "List Price - Lowest 365 days": None,
    "List Price - Highest": None,
    "List Price - Highest 365 days": None,
    "List Price - 90 days OOS": stable_list_price,
    "List Price - Stock": stable_list_price,
