...
from stable import sales_rank_current, sales_rank_30_days_avg, sales_rank_90_days_avg, sales_rank_180_days_avg, sales_rank_365_days_avg, used_current, package_quantity, package_weight, package_height, package_length, package_width, used_like_new, used_like_new_lowest_highest, used_very_good, used_good, used_acceptable, new_3rd_party_fbm_current, new_3rd_party_fbm, list_price
from Keepa_Deals import used_like_new as keepa_used_like_new, used_very_good as keepa_used_very_good, used_good as keepa_used_good, used_acceptable as keepa_used_acceptable, new_3rd_party_fbm as keepa_new_3rd_party_fbm, list_price as keepa_list_price
...
FUNCTION_MAP = {
    ...
    "New, 3rd Party FBM - 30 days avg.": keepa_new_3rd_party_fbm,
    "New, 3rd Party FBM - 60 days avg.": keepa_new_3rd_party_fbm,
    "New, 3rd Party FBM - 90 days avg.": keepa_new_3rd_party_fbm,
    "New, 3rd Party FBM - 180 days avg.": keepa_new_3rd_party_fbm,
    "New, 3rd Party FBM - 365 days avg.": keepa_new_3rd_party_fbm,
    ...
    "New, 3rd Party FBM - Stock": keepa_new_3rd_party_fbm,
    ...
    "Used, like new - 30 days avg.": keepa_used_like_new,
    "Used, like new - 60 days avg.": keepa_used_like_new,
    "Used, like new - 90 days avg.": keepa_used_like_new,
    "Used, like new - 180 days avg.": keepa_used_like_new,
    "Used, like new - 365 days avg.": keepa_used_like_new,
    "Used, like new - Lowest": used_like_new_lowest_highest,
    "Used, like new - Lowest 365 days": None,
    "Used, like new - Highest": used_like_new_lowest_highest,
    "Used, like new - Highest 365 days": None,
    "Used, like new - 90 days OOS": keepa_used_like_new,
    "Used, like new - Stock": keepa_used_like_new,
    "Used, very good - Current": used_very_good,
    "Used, very good - 30 days avg.": keepa_used_very_good,
    "Used, very good - 60 days avg.": keepa_used_very_good,
    "Used, very good - 90 days avg.": keepa_used_very_good,
    "Used, very good - 180 days avg.": keepa_used_very_good,
    "Used, very good - 365 days avg.": keepa_used_very_good,
    ...
    "Used, very good - Stock": keepa_used_very_good,
    "Used, good - Current": used_good,
    "Used, good - 30 days avg.": keepa_used_good,
    "Used, good - 60 days avg.": keepa_used_good,
    "Used, good - 90 days avg.": keepa_used_good,
    "Used, good - 180 days avg.": keepa_used_good,
    "Used, good - 365 days avg.": keepa_used_good,
    "Used, good - Lowest": None,
    "Used, good - Lowest 365 days": None,
    "Used, good - Highest": None,
    "Used, good - Highest 365 days": None,
    "Used, good - 90 days OOS": keepa_used_good,
    "Used, good - Stock": keepa_used_good,
    "Used, acceptable - Current": used_acceptable,
    "Used, acceptable - 30 days avg.": keepa_used_acceptable,
    "Used, acceptable - 60 days avg.": keepa_used_acceptable,
    "Used, acceptable - 90 days avg.": keepa_used_acceptable,
    "Used, acceptable - 180 days avg.": keepa_used_acceptable,
    "Used, acceptable - 365 days avg.": keepa_used_acceptable,
    ...
    "Used, acceptable - 90 days OOS": keepa_used_acceptable,
    "Used, acceptable - Stock": keepa_used_acceptable,
    "List Price - Current": list_price,
    "List Price - 30 days avg.": keepa_list_price,
    "List Price - 60 days avg.": keepa_list_price,
    "List Price - 90 days avg.": keepa_list_price,
    "List Price - 180 days avg.": keepa_list_price,
    "List Price - 365 days avg.": keepa_list_price,
    "List Price - Lowest": None,
    "List Price - Lowest 365 days": None,
    "List Price - Highest": None,
    "List Price - Highest 365 days": None,
    "List Price - 90 days OOS": keepa_list_price,
    "List Price - Stock": keepa_list_price,
