...
from stable import (
    ...
    list_price_averages, used_like_new_averages, used_very_good_averages,
    used_good_averages, used_acceptable_averages, new_3rd_party_fbm
)
...
FUNCTION_MAP = {
    ...
    "Used, like new - 30 days avg.": used_like_new_averages,
    "Used, like new - 60 days avg.": used_like_new_averages,
    "Used, like new - 90 days avg.": used_like_new_averages,
    "Used, like new - 180 days avg.": used_like_new_averages,
    "Used, like new - 365 days avg.": used_like_new_averages,
    "Used, like new - Lowest": None,
    "Used, like new - Lowest 365 days": None,
    "Used, like new - Highest": None,
    "Used, like new - Highest 365 days": None,
    "Used, like new - 90 days OOS": used_like_new_averages,
    "Used, like new - Stock": used_like_new_averages,
    "Used, very good - Current": used_very_good,
    "Used, very good - 30 days avg.": used_very_good_averages,
    "Used, very good - 60 days avg.": used_very_good_averages,
    "Used, very good - 90 days avg.": used_very_good_averages,
    "Used, very good - 180 days avg.": used_very_good_averages,
    "Used, very good - 365 days avg.": used_very_good_averages,
    ...
    "Used, very good - Stock": used_very_good_averages,
    "Used, good - Current": used_good,
    "Used, good - 30 days avg.": used_good_averages,
    "Used, good - 60 days avg.": used_good_averages,
    "Used, good - 90 days avg.": used_good_averages,
    "Used, good - 180 days avg.": used_good_averages,
    "Used, good - 365 days avg.": used_good_averages,
    "Used, good - Lowest": None,
    "Used, good - Lowest 365 days": None,
    "Used, good - Highest": None,
    "Used, good - Highest 365 days": None,
    "Used, good - 90 days OOS": used_good_averages,
    "Used, good - Stock": used_good_averages,
    "Used, acceptable - Current": used_acceptable,
    "Used, acceptable - 30 days avg.": used_acceptable_averages,
    "Used, acceptable - 60 days avg.": used_acceptable_averages,
    "Used, acceptable - 90 days avg.": used_acceptable_averages,
    "Used, acceptable - 180 days avg.": used_acceptable_averages,
    "Used, acceptable - 365 days avg.": used_acceptable_averages,
    ...
    "Used, acceptable - 90 days OOS": used_acceptable_averages,
    "Used, acceptable - Stock": used_acceptable_averages,
    "List Price - Current": list_price,
    "List Price - 30 days avg.": list_price_averages,
    "List Price - 60 days avg.": list_price_averages,
    "List Price - 90 days avg.": list_price_averages,
    "List Price - 180 days avg.": list_price_averages,
    "List Price - 365 days avg.": list_price_averages,
    "List Price - Lowest": None,
    "List Price - Lowest 365 days": None,
    "List Price - Highest": None,
    "List Price - Highest 365 days": None,
    "List Price - 90 days OOS": list_price_averages,
    "List Price - Stock": list_price_averages,
