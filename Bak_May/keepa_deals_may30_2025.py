...
from stable import (
    ...
    used_acceptable, new_3rd_party_fbm_current, list_price, used_offer_count_current
)
...
# Define functions list using header_map.py - start
...
# Define functions list using header_map.py - end
