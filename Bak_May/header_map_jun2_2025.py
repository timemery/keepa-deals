# header_map.py - updated to fix ImportError and align with stable.py
...
from Keepa_Deals import (
    list_price as deals_list_price, new_3rd_party_fbm, used_like_new as deals_used_like_new,
...
FUNCTION_MAP = {
    ...
    "List Price - 30 days avg.": deals_list_price,
    "List Price - 60 days avg.": deals_list_price,
    "List Price - 90 days avg.": deals_list_price,
    "List Price - 180 days avg.": deals_list_price,
    "List Price - 365 days avg.": deals_list_price,
    "List Price - Lowest": None,
    "List Price - Lowest 365 days": None,
    "List Price - Highest": None,
    "List Price - Highest 365 days": None,
    "List Price - 90 days OOS": deals_list_price,
    "List Price - Stock": deals_list_price,
