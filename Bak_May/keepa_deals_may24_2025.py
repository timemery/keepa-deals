...
# This is where header_map.py stuff starts:            
        from header_map import FUNCTION_MAP
        ...
        logging.debug(f"Unmapped headers: {[h for h in headers if h in FUNCTION_MAP or not FUNCTION_MAP[h]]}")
# This is where header_map.py stuff ends
